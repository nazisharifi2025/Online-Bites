      ...
      <!-- div 1 -->
       <div dir="rtl" class=" h-full flex w-[100%] flex-col bg-green-950/80">
            ...
            <div class="h-full w-full flex justify-center items-center flex-col gap-6">
                <form action=<?php echo $_SERVER["PHP_SELF"]; ?> method="POST" class="h-[85vh] w-[50%]  text-center items-center font-bold text-xl  bg-black/40 rounded-md  flex-col gap-6  text-white flex justify-center  py-3">
