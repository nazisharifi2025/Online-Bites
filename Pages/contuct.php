...
<body dir="rtl">
    ...
    <div class="h-full w-full flex flex-col gap-6 justify-center text-green-950/80 items-center bg-black/25">
    ...
    <!-- hero endded -->
     <div class="w-[60%] mx-auto h-[70vh] gap-5 flex flex-col text-green-950/80 justify-center items-start">
        <h1 class="text-3xl my-6 font-bold">تماس با ما</h1>
        <span class="text-xl text-gray-500">مکان: بازار حوتقول جاغوری</span>
        <span class="text-xl text-gray-500">تلفن: 0795064649</span>
        <span class="text-xl text-gray-500">دارای سرویس رایگان</span>
        <span class="text-xl text-gray-500">شماره تماس با مدیر: 0799048877</span>
        <span class="text-xl text-gray-500">سرویس آنلاین در تمام روز های هفته</span>
        <span class="text-xl text-gray-500">شنبه تا جمعه</span>
     </div>
 <!-- endded -->
