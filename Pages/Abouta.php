...
<body>
    ...
    <div class="h-[60vh] w-[70%]  text-center font-bold text-xl  rounded-md bg-gradient-to-l flex-col gap-6 from-black/60 to-red-300 text-white flex justify-center items-center border py-3">
